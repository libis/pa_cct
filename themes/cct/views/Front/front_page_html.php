<?php
	MetaTagManager::setWindowTitle($this->request->config->get("app_display_name").": About CCT-DATABASE");
?>
<H1><?php print _t("About CCT-DATABASE"); ?></H1>
...
<div class="row" style="text-align: justify; text-justify: inter-word;">
	...
	<div class="col-sm-8">
		<p>
			...
			Ad Dudink & Nicolas Standaert, Chinese Christian Texts Database (CCT-Database) (<a href="http://www.arts.kuleuven.be/sinology/cct" target="_blank" style="border-bottom-width: 1px; border-bottom-color: rgb(12, 120, 139); color: rgb(114, 170, 190); text-decoration: none;">http://www.arts.kuleuven.be/sinology/cct</a>).</p>
		</p>
	</div>
	<div class="col-sm-8">
		<p>
			<b><H6>Additions and mistakes</H6></b>
			<p>The description of sources, especially primary sources, is still incomplete and therefore the authors will continuously insert further details and update existing descriptions. If you want to propose additions or point out mistakes, please send us a mail via ‘Contact’. Substantial addenda or corrigenda will be acknowledged in the 'notes on author', 'notes on contents' or 'notes on text history'.</p>
		</p>
	</div>
	<div class="col-sm-8">
		<p>
			<b><H6>Authors</H6></b>
			<ul>
				<li><a href="http://cwisdb.kuleuven.be/persdb-bin/persdb?lang=N&oproep=persoon&fnaam=u0016226" target="_blank" style="border-bottom-width: 1px; border-bottom-color: rgb(12, 120, 139); color: rgb(114, 170, 190); text-decoration: none;">Ad Dudink</a>, Sinology KU Leuven</li>
				<li><a href="http://cwisdb.kuleuven.be/persdb-bin/persdb?lang=N&oproep=persoon&fnaam=u0013792" target="_blank" style="border-bottom-width: 1px; border-bottom-color: rgb(12, 120, 139); color: rgb(114, 170, 190); text-decoration: none;">Nicolas Standaert</a>, Sinology KU Leuven</li>
			</ul>
		</p>
	</div>
	<div class="col-sm-3 col-sm-offset-1">
		<address>University of Leuven<br>Sinology<br>Blijde Inkomststraat 21 bus 3318<br>B-3000 Leuven, BELGIUM<br></address>
	</div>
</div>