		...
		if ($vn_start < $qr_res->numHits()) {
			...
			while($qr_res->nextHit() && ($vn_c < $vn_hits_per_block)) {
                ...
                if ($vs_table == 'ca_objects'){
                    ...
                    $vs_author_template = "^ca_entities.preferred_labels.displayname%restrictToRelationshipTypes=aut<ifdef code=\"ca_entities.preferred_labels.suffix\" restrictToRelationshipTypes='aut'>[^ca_entities.preferred_labels.suffix%restrictToRelationshipTypes=aut]</ifdef>^ca_entities.preferred_labels.prefix%restrictToRelationshipTypes=aut<case><ifcount code=\"ca_entities.nonpreferred_labels\" min=\"1\" max=\"1\" restrictToRelationshipTypes='aut'>^ca_entities.nonpreferred_labels.displayname%restrictToRelationshipTypes=aut</ifcount><ifcount code=\"ca_entities.nonpreferred_labels\" min=\"2\" restrictToRelationshipTypes='aut'>(^ca_entities.nonpreferred_labels.displayname%restrictToRelationshipTypes=aut&delimiter=_-_)</ifcount></case><ifdef code=\"ca_entities.marc700d\" restrictToRelationshipTypes='aut'>(^ca_entities.marc700d%restrictToRelationshipTypes=aut)</ifdef><unit relativeTo=\"ca_objects_x_entities\" restrictToRelationshipTypes=aut delimiter=\" / \"><ifdef code=\"ca_objects_x_entities.marc700.marc7009\">(^ca_objects_x_entities.marc700.marc7009%restrictToRelationshipTypes=aut)</ifdef></unit>";
