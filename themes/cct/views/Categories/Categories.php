<?php
    ...
    while($qr_result->nextRow()) {
        $item_labels[$qr_result->get('name_singular')] = $qr_result->get('item_id');
    }
    ...
    <div class="col-sm-8">
        <div class="" id="parent-fieldname-text-6e25d7c040c2428c8cd2b81223a8a35b">
            <table border="1" cellpadding="0" cellspacing="0">
                <tbody>
                <?php foreach ($item_labels as $label=>$id) {
                    ...
                    if(isset($values[1])){
                        ...
                        echo "<td valign='top' style='white-space: nowrap'> <a href='/$base_search_url:$id' style='text-decoration: none'>$category_text</a> </td>";
                    }
